...
This project uses [ProAgents](https://github.com/prakashpro3/proAgents). Type these commands:
...
| \`/doc-release\` | Generate release notes |
...
`;
    ...
    console.log('Just type commands in any AI:');
    console.log(chalk.cyan('  /help                      ') + chalk.gray('Show all commands'));
    console.log(chalk.cyan('  /feature-start "name"      ') + chalk.gray('Start new feature'));
    console.log(chalk.cyan('  /fix "bug description"     ') + chalk.gray('Quick bug fix'));
    console.log(chalk.cyan('  /status                    ') + chalk.gray('Show progress'));
    console.log(chalk.cyan('  /doc-release               ') + chalk.gray('Generate release notes'));
