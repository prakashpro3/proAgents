...
- [config/standards/testing-standards.template.md](../config/standards/testing-standards.template.md) - Alternative location
- [testing-standards/](../testing-standards/) - Detailed testing guides
